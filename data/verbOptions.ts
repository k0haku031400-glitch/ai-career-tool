...
export const VERBS: VerbItem[] = [
  ...
  { id: "think-essence", label: "物事の本質を深く考えて核心を掴む", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  ...
  { id: "think-mechanism", label: "物事の仕組みを理解して改善案を考える", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  ...
  { id: "think-strategy", label: "長期的な戦略を立てて目標達成の道筋を作る", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  ...
  { id: "think-carefully", label: "時間をかけてじっくり考えて最適解を見つける", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  ...
  // C（コミュニケーション）追加30個
  { id: "c-001", label: "相手の表情や仕草から気持ちを読み取る", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-002", label: "初対面の場で自己紹介をして印象を残す", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-003", label: "相手の名前を覚えて次回会った時に呼ぶ", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-004", label: "相手の趣味や興味を聞いて共通点を見つける", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-005", label: "相手の話に相槌を打って理解を示す", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-006", label: "相手の成功を一緒に喜んで祝福する", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-007", label: "相手の失敗を受け止めて支える", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-008", label: "相手の価値観を尊重して受け入れる", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-009", label: "相手の話を遮らず最後まで聞き切る", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-010", label: "相手の悩みに共感して寄り添う", group: "C", category: "人と関わる行動", subcategory: "関係構築" },
  { id: "c-011", label: "相手の質問に丁寧に答えて理解を深める", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-012", label: "相手の反対意見を聞いて建設的に議論する", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-013", label: "相手の理解度を確認しながら説明を進める", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-014", label: "相手の興味に合わせて話題を選ぶ", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-015", label: "相手の意見を聞いてから自分の考えを伝える", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-016", label: "相手の質問に対して具体例を交えて説明する", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-017", label: "相手の理解を確認するために質問を返す", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-018", label: "相手の提案を尊重して検討する姿勢を示す", group: "C", category: "人と関わる行動", subcategory: "発信・説得" },
  { id: "c-019", label: "相手の成長を認めて具体的に評価する", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-020", label: "相手の強みを見つけて活かす方法を提案する", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-021", label: "相手の目標達成をサポートして応援する", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-022", label: "相手の学習を支援して知識を共有する", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-023", label: "相手の挑戦を後押しして背中を押す", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-024", label: "相手の不安を取り除いて安心感を与える", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-025", label: "相手の意見を引き出して対話を深める", group: "C", category: "人と関わる行動", subcategory: "支援・育成" },
  { id: "c-026", label: "場の雰囲気を和らげて緊張を解く", group: "C", category: "人と関わる行動", subcategory: "場づくり" },
  { id: "c-027", label: "場の空気を読んで適切なタイミングで発言する", group: "C", category: "人と関わる行動", subcategory: "場づくり" },
  { id: "c-028", label: "場の雰囲気を明るくして楽しさを演出する", group: "C", category: "人と関わる行動", subcategory: "場づくり" },
  { id: "c-029", label: "場の参加者全員が話しやすい環境を作る", group: "C", category: "人と関わる行動", subcategory: "場づくり" },
  { id: "c-030", label: "場の意見をまとめて合意形成を促す", group: "C", category: "人と関わる行動", subcategory: "場づくり" },
  
  // L（リーダーシップ）追加30個
  { id: "l-001", label: "チームの目標を明確にして全員で共有する", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-002", label: "困難な状況でも決断して前に進む", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-003", label: "自分の判断に責任を持って結果を受け止める", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-004", label: "複数の選択肢を比較して最善の判断をする", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-005", label: "期限を設定して目標達成の計画を立てる", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-006", label: "リスクを考慮して慎重に判断する", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-007", label: "自分の信念に基づいて決断を下す", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-008", label: "チームの意見を聞いてから最終判断をする", group: "L", category: "行動・挑戦に関すること", subcategory: "意思決定・責任" },
  { id: "l-009", label: "計画を立ててから実行に移す", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-010", label: "途中で諦めず最後までやり遂げる", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-011", label: "毎日の習慣を継続して成果を積み上げる", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-012", label: "目標に向かって計画的に行動を続ける", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-013", label: "困難な状況でも諦めずに継続する", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-014", label: "自分の行動を振り返って改善する", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-015", label: "期限を守って確実に成果を出す", group: "L", category: "行動・挑戦に関すること", subcategory: "実行・継続" },
  { id: "l-016", label: "チームの先頭に立って方向性を示す", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-017", label: "チームメンバーのやる気を引き出す", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-018", label: "チームの結束を高めて一体感を作る", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-019", label: "チームメンバーの意見を聞いて取り入れる", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-020", label: "チームの目標達成に向けて全員を動かす", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-021", label: "チームの課題を解決して前に進める", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-022", label: "チームの強みを活かして成果を出す", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-023", label: "チームのモチベーションを維持して高める", group: "L", category: "行動・挑戦に関すること", subcategory: "巻き込み・リード" },
  { id: "l-024", label: "新しいことに挑戦して経験を積む", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-025", label: "失敗を恐れずに挑戦し続ける", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-026", label: "現状に満足せず常に改善を目指す", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-027", label: "変化を恐れずに新しい環境に飛び込む", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-028", label: "問題を発見して改善策を実行する", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-029", label: "困難な状況でも前向きに取り組む", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  { id: "l-030", label: "自分の限界に挑戦して成長する", group: "L", category: "行動・挑戦に関すること", subcategory: "挑戦・変化" },
  
  // T（思考・分析）追加30個
  { id: "t-001", label: "データを分析して傾向やパターンを見つける", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-002", label: "問題の原因を特定して解決策を考える", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-003", label: "複数のデータを比較して違いを見つける", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-004", label: "情報を集めて全体像を把握する", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-005", label: "問題を細かく分解して理解する", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-006", label: "データから仮説を立てて検証する", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-007", label: "情報の信頼性を確認して判断する", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-008", label: "複数の視点から物事を分析する", group: "T", category: "考える・整理すること", subcategory: "分析・原因究明" },
  { id: "t-009", label: "情報をカテゴリ別に分類して整理する", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-010", label: "複雑な情報を簡潔にまとめて伝える", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-011", label: "情報を時系列で整理して流れを理解する", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-012", label: "情報を階層化して構造を明確にする", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-013", label: "情報の要点を抽出して要約する", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-014", label: "情報を視覚化して理解しやすくする", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-015", label: "情報を体系化して知識として蓄積する", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-016", label: "情報の関連性を見つけて整理する", group: "T", category: "考える・整理すること", subcategory: "構造化・要約" },
  { id: "t-017", label: "長期的な計画を立てて目標達成を目指す", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-018", label: "複数のタスクを優先順位付けして処理する", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-019", label: "効率的な手順を考えて実行する", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-020", label: "リソースを最適化して効率を上げる", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-021", label: "計画を立ててから実行に移す", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-022", label: "計画を見直して改善する", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-023", label: "複数の選択肢を評価して最適な選択をする", group: "T", category: "考える・整理すること", subcategory: "計画・優先順位" },
  { id: "t-024", label: "仮説を立てて実験で検証する", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-025", label: "論理的に思考して結論を導く", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-026", label: "複数の仮説を比較して最適なものを選ぶ", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-027", label: "結果を分析して仮説を検証する", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-028", label: "将来の状況を予測して準備する", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-029", label: "論理的な説明を組み立てて伝える", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
  { id: "t-030", label: "複数の情報源から情報を集めて判断する", group: "T", category: "考える・整理すること", subcategory: "仮説・検証" },
];
